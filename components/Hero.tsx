...
{/* grid */}
      <div
       className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.03] bg-grid-black/[0.2] flex items-center justify-center top-0 left-0 absolute">
     ...
     <div className='flex justify-center relative my-20 z-10'>
      <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center' >
        ...
        <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>Hi, I'm Harsh Bisht,
        a Next.js and WEB Developer based in Delhi
        </p>
        <a href='#about'>
